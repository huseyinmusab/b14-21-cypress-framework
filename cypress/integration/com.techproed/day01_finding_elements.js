describe('Finding Elements',()=>{
    it('get method', ()=>{
        ...
        //2. find() is used to find any element after get() (a kind of narrowing search )
        ...
        cy.get('li').find("a[href='/Rooms/6']").should('have.length',1) //(find first all get than, find() child of them )
